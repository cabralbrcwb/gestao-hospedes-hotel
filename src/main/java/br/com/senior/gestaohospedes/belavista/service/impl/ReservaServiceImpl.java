...
public class ReservaServiceImpl implements ReservaService {
  ...
  public Reserva criarReserva(ReservaRequestDTO dto) {
    ...
    // CORREÇÃO: Status ativos agora incluem PENDENTE para evitar sobreposição
    ...
    // CORREÇÃO: Nova reserva começa como PENDENTE
  ...
  public Reserva realizarCheckIn(Long idReserva) {
    ...
    // CORREÇÃO: Check-in deve ser feito em uma reserva PENDENTE
