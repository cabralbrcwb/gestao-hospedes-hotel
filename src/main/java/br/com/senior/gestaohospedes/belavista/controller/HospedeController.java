...
public class HospedeController {
    ...
    public List<Hospede> listarHospedes(@RequestParam(required = false) String nome,
        ...
        log.info("Requisição para buscar hóspedes com filtros - Nome: {}, Documento: {}, Telefone: {}", nome, documento, telefone);
        List<Hospede> hospedes = hospedeService.buscarHospedes(nome, documento, telefone);
